...
class CreditCardNumberInputFilter(private val editText: EditText) : TextWatcher {
    private var isFormatting = false
    private val mask = "XXXX XXXX XXXX XXXX"
    ...
    override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
        if (!isFormatting) {
            ...
            val formattedString = formatCreditCardNumber(cleanedString, mask)
    ...
    private fun formatCreditCardNumber(number: String, mask: String): String {
