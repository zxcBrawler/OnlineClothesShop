...
class ExpDateInputFilter(private val editText: EditText) : TextWatcher {
    private var isFormatting = false
    private val mask = "XX/XX"
    ...
    override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
        if (!isFormatting) {
            ...
            val formattedString = formatExpDate(cleanedString, mask)
    ...
    private fun formatExpDate(number: String, mask: String): String {
